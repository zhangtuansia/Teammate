...
function ThreadRow({
  ...
  return (
    <div
      className={`group flex gap-2 px-5 py-2 hover:bg-accent/40 ${
...
export function ThreadPanel({
  ...
  return (
    ...
    <aside className="flex flex-1 flex-col border-l-[0.5px] bg-card lg:w-[400px] lg:flex-none">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto py-4" ref={scrollRef}>
      ...
      <div className="px-5 pb-5 pt-2">
        <div className="overflow-hidden rounded-[8px] border bg-card shadow-[0_1px_3px_0_rgba(0,0,0,0.08)] transition-shadow focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/24">
          <TiptapMessageInput
